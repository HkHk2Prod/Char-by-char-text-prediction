...
class TextDataset(Dataset):
    ...
    def generate_test_train(
        ...
        train_ds = TextDataset(
            text=text[:val_start], seq_length=seq_length, vocab=vocab
        )
        val_ds = TextDataset(
            text=text[val_start:test_start], seq_length=seq_length, vocab=vocab
        )
        test_ds = TextDataset(
            text=text[test_start:n], seq_length=seq_length, vocab=vocab
        )
